...
var STACK_BASE = 5253808, STACK_MAX = 10928, DYNAMIC_BASE = 5253808, DYNAMICTOP_PTR = 10752;
...
if (Module["wasmMemory"]) {
 ...
 wasmMemory = new WebAssembly.Memory({
  ...
  "maximum": 2097152e3 / WASM_PAGE_SIZE
 });
}
...
var wasmBinaryFile = "resident_counter.wasm";
...
function _example_javascript_c_api(x) {
 console.log("this is a test message from the WASM js library in sim_backends/c_wasm/lib.js");
}
...
var asmLibraryArg = {
 ...
 "example_javascript_c_api": _example_javascript_c_api,
 "fd_write": _fd_write,
 ...
 "invoke_vijiifiii": invoke_vijiifiii,
 "memory": wasmMemory,
...
var dynCall_vijiifiii = Module["dynCall_vijiifiii"] = createExportWrapper("dynCall_vijiifiii");
...
function invoke_vijiifiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
 var sp = stackSave();
 try {
  dynCall_vijiifiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9);
 } catch (e) {
  stackRestore(sp);
  if (e !== e + 0 && e !== "longjmp") throw e;
  _setThrew(1, 0);
